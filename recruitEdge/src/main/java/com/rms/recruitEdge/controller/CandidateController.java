...
public class CandidateController {
    ...
    @GetMapping("/get/{id}")
    public ResponseEntity<CandidateResponse> getCandidateById(@PathVariable(name="id",required=true)Long id){
    ...
    public ResponseEntity<String> updateCandidate(@PathVariable(name="id")Long id,@RequestBody CandidateRequest req){
    ...
    public ResponseEntity<String> deleteCandiate(@PathVariable(name="id")Long id){
