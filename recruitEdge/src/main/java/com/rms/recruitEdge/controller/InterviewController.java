...
public class InterviewController {
    ...
    @GetMapping("/get/{id}")
    public ResponseEntity<InterviewResponse> getInterviewById(@PathVariable(name="id",required=true)Long id){
    ...
    public ResponseEntity<String> updateInterview(@PathVariable(name="id")Long id,@RequestBody InterviewRequest req){
